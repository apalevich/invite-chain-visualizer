...
VALUES
  ('123456789', 'john_doe', 'John', 'Doe', '2024-01-01T10:00:00Z'::timestamptz);
...
BEGIN
  ...
  VALUES
    ('223456789', 'alice_smith', 'Alice', 'Smith', first_user_id, '2024-01-02T14:30:00Z'::timestamptz),
    ('323456789', 'bob_wilson', 'Bob', 'Wilson', first_user_id, '2024-01-03T09:15:00Z'::timestamptz),
    ('423456789', 'carol_brown', 'Carol', 'Brown', first_user_id, '2024-01-04T16:45:00Z'::timestamptz);
